...
CREATE TABLE EVENTO_USUARIO (
    ...
    ID_USUARIO INT NOT NULL,
    ID_ESTADO INT NOT NULL,
    CONSTRAINT [PK_EVENTO_USUARIO] PRIMARY KEY (ID_EVENTO ASC),
...
CREATE TABLE MENSAJE_USUARIO (
    ...
    ID_USUARIO INT NOT NULL,
    ID_ESTADO INT NOT NULL,
    HORA_RECIBIDO DATETIME NULL,
   CONSTRAINT [PK_MENSAJE_USUARIO] PRIMARY KEY (ID_MENSAJE ASC, ID_USUARIO ASC),
     CONSTRAINT FK_MENSAJE_USUARIO_MENSAJE FOREIGN KEY (ID_MENSAJE) REFERENCES MENSAJE(ID_MENSAJE),
    CONSTRAINT FK_MENSAJE_USUARIO_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(ID_USUARIO),
    CONSTRAINT FK_MENSAJE_USUARIO_ESTADO FOREIGN KEY (ID_ESTADO) REFERENCES ESTADO(ID_ESTADO)
);
GO
